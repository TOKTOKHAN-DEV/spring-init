...
enum class UserExceptionCode(
    ...
    NOT_MATCH_CURRENT_PASSWORD(HttpStatus.BAD_REQUEST, "NOT_MATCH_CURRENT_PASSWORD", "비밀번호를 다시 확인해주세요"),
    NOT_MATCH_CHANGE_PASSWORD(HttpStatus.BAD_REQUEST, "NOT_MATCH_CHANGE_PASSWORD", "비밀번호가 일치하지 않습니다"),
