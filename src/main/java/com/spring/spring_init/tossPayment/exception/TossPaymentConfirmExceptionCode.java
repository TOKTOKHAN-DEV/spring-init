...
public enum TossPaymentConfirmExceptionCode implements BaseErrorCode {
	...
	INVALID_API_KEY(HttpStatus.BAD_REQUEST, "INVALID_API_KEY", "잘못된 시크릿키 연동 정보 입니다."),
	...
	INVALID_AUTHORIZE_AUTH(HttpStatus.BAD_REQUEST, "INVALID_AUTHORIZE_AUTH", "유효하지 않은 인증 방식입니다."),
	...
	INVALID_UNREGISTERED_SUBMALL(HttpStatus.BAD_REQUEST, "INVALID_UNREGISTERED_SUBMALL", "등록되지 않은 서브몰입니다. 서브몰이 없는 가맹점이라면 안심클릭이나 ISP 결제가 필요합니다."),
	...
	EXCEED_MAX_MONTHLY_PAYMENT_AMOUNT(HttpStatus.BAD_REQUEST, "EXCEED_MAX_MONTHLY_PAYMENT_AMOUNT", "당월 결제 가능금액인 1,000,000원을 초과 하셨습니다."),
	...
	PAYMENT_CONFIRM_ERROR_MISMATCH_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "PAYMENT_CONFIRM_ERROR_MISMATCH_ERROR", "결제 과정에서 서버 에러가 발생했습니다."),
	...
	TossPaymentConfirmExceptionCode(HttpStatus httpStatusCode, String code, String message) {
		this.httpStatusCode = httpStatusCode;
		this.code = code;
		this.message = message;
	}
	
	public static TossPaymentConfirmExceptionCode findByCode(String code) {
